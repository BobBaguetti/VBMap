document.addEventListener('DOMContentLoaded', () => {
  ...
  // Global array for markers (for search and editing)
  let allMarkers = [];

  // ------------------------------
  // Utility: Custom Context Menu (always enabled)
  ...
  function addMarker(markerData) {
    ...
    // Attach context menu for editing (always enabled)
      ...
      showContextMenu(e.originalEvent.pageX, e.originalEvent.pageY, [
        {
          text: "Edit Marker",
          action: function () {
            // Populate edit modal with current marker data and show it
  ...
  // ------------------------------
  // Right-Click on Map to Create New Marker (Always Enabled)
    ...
    showContextMenu(e.originalEvent.pageX, e.originalEvent.pageY, [
      {
        ...
        action: function () {
          ...
          editForm.onsubmit = function (ev) {
            ...
            hideEditModal();
            // Reset onsubmit handler after creation
