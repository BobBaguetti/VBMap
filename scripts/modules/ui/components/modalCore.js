...
// @version: 2.1 – low-level modal creation, focus-trap, backdrop, open/close logic
...
export function createModalCore({
  ...
  function attachLifecycle() {
    ...
    // global key listener so ESC always works
  ...
  function open() {
    ...
    setTimeout(() => {
      const focusTarget = content.querySelector("input, button, [tabindex]") || content;
      focusTarget.focus();
    }, 0);
  }
