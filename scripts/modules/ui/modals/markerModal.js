...
// @version: 17 – restored original Item modal + Chest integration
...
/**
 * One single modal for editing *or* creating any marker,
 * including Chest instances (via the "Chest Type" dropdown).
 */
export function initMarkerModal(db) {
  ...
  async function openEdit(markerObj, data, evt, onSave) {
    ...
    // if it was an Item with a predefined ID
