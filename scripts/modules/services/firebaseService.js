...
/**
 * Initialize Firebase if not already initialized, and return the Firestore instance.
...
/**
 * Ensure no undefined values are sent to Firestore. Converts undefined to empty strings.
 * @param {Object} obj The object to sanitize.
 * @returns {Object} A new object with no undefined values.
 */
...
export async function updateMarker(db, markerData) {
  try {
    const payload = sanitizeForFirestore(markerData);
    await db.collection("markers").doc(markerData.id).set(payload);
