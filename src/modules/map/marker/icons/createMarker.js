...
// @version: 1.0 — factory for Leaflet markers with custom icon, popup, & context menu
...
/**
 * Create a Leaflet marker with custom icon, popup, drag, and contextmenu.
 *
