 ...
 * @param {function} getCustom     — function returning the current payload
 * @param {function} onSubmit      — called with getCustom() on form submit
 * @param {function} onFieldChange — called with getCustom() on any input change
 */
