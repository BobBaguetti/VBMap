...
const INLINE_SVGS = {
  ...
  /**
   * Inline SVG for the heart (HP) icon.
   * Using a thick-stroked filled heart for better visibility.
   */
  heart: `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18">
      <path
        d="M462.3 62.7C407 7.4 324.8-10.6 256 37.9 187.2-10.6 105 7.4 49.7 62.7c-62.8 62.9-66.1 164.2-9.9 227.8L239 470.6c12.5 12.4 32.8 12.4 45.3 0l199.2-180.1c56.3-63.6 52.9-164.9-9.2-227.8z"
        fill="#e05252" stroke="#e05252" stroke-width="32"/>
    </svg>`
};
